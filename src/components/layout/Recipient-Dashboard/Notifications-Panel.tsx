...
const notifications = [
  ...
  },
  {
    id: "2",
    type: "request",
    content: "Your request for winter clothes has been approved",
    time: "30 minutes ago",
    avatar: "/placeholder.svg?height=40&width=40",
    read: false,
  },
  {
    id: "3",
    type: "request",
    content: "Food for All is reviewing your food assistance request",
    time: "2 hours ago",
    avatar: "/placeholder.svg?height=40&width=40",
    read: false,
  },
  {
    id: "4",
    type: "message",
    content: "Children's Hope Alliance sent you a message",
    time: "1 day ago",
    avatar: "/placeholder.svg?height=40&width=40",
    read: true,
  },

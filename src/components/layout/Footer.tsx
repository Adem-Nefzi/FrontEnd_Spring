...
// Footer sub-components and data
const platformLinks = [
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground text-sm">
        Empowering generosity and transparent giving through innovative donation
        management. Together, we can make a difference in communities worldwide.
      </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          <div className="md:col-span-2 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Subscribe to our newsletter for updates on campaigns and impact
              stories.
            </p>
          </div>
